...
public class EmployeeController extends BaseController {
	...
	public void pdf(@PathVariable String id) throws IOException {
		...
		// 2.构造数据
		// a.用户详情数据
		UserCompanyPersonal personal = userCompanyPersonalService.findById(id); // b.用户岗位信息数据
...
//        		        wb.write(response.getOutputStream());
      ...
      //文档输出在服务器断
        FileOutputStream out = new FileOutputStream("/Users/mac/Desktop/Thq/excel/poi/e003.xlsx");
        wb.write(out);
        out.close();
...
//        
////      //文档输出在服务器断
//      FileOutputStream out = new FileOutputStream("/Users/mac/Desktop/Thq/excel/poi/e002.xlsx");
//      wb.write(out);
//      out.close();
//        //7.下载
//        //3.完成下载
